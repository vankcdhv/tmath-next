...
import {
  ...
  fetchOther,
  fetchStudents
} from 'core/store/slices/article';
...
const ArticleList: React.FC = () => {
  ...
  const closeModal = (isDone: boolean) => {
    ...
    setSelectedItem({detail: '', content: '', id: '', image: [], title: '', type: '', url: ''});
    if (isDone) {
      initData();
    }
  };
    ...
    <div>
      <div className={'article'}>
        ...
        <ArticleCollection articles={articleState.courses} type={ARTICLE_TYPE_COURSE} updateArticle={updateArticle}
          deleteArticle={deleteArticle}/>
        <ArticleCollection articles={articleState.others} type={ARTICLE_TYPE_OTHER} updateArticle={updateArticle}
          deleteArticle={deleteArticle}/>
